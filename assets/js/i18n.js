...
var ABO_I18N = (function () {
  ...
  var T = {
    ...
    es: {
      ...
      "cookieConsent.text": "Tu privacidad importa. Utilizamos cookies para operar nuestro sitio y analizar el tráfico. Más información en nuestra <a href=\"privacy-policy.html\">Política de Privacidad</a>.",
      "cookieConsent.acceptAll": "Aceptar",
      "cookieConsent.rejectAll": "Rechazar",
      ...
      "title.privacyPolicy": "Política de Privacidad — ABÔ Atelier",
      "privacyPolicy.title": "Política de Privacidad",
      "privacyPolicy.placeholder": "Política de marcador de posición — reemplace esta página con la política de privacidad real de ABÔ Atelier, revisada por un abogado, antes de confiar en ella.",
      "privacyPolicy.dataHeading": "Qué Información Recopilamos",
      "privacyPolicy.dataBody": "Recopilamos la información que nos proporcionas directamente — como tu nombre, correo electrónico y número de teléfono al suscribirte a nuestro boletín, contactarnos o realizar un pedido — y la información recopilada automáticamente mediante cookies (ver abajo).",
      "privacyPolicy.whatAreHeading": "¿Qué son las Cookies?",
      "privacyPolicy.whatAreBody": "Las cookies son pequeños datos almacenados en tu dispositivo que ayudan a que los sitios web funcionen y a entender cómo se utilizan.",
      "privacyPolicy.necessaryHeading": "Cookies Necesarias",
      "privacyPolicy.necessaryBody": "Son necesarias para que el sitio funcione correctamente, por ejemplo, para recordar el contenido de tu carrito y el idioma seleccionado. No se pueden desactivar y no te rastrean en otros sitios.",
      "privacyPolicy.analyticsHeading": "Cookies Analíticas",
      "privacyPolicy.analyticsBody": "Con tu consentimiento, utilizamos Google Analytics para entender cómo los visitantes usan nuestro sitio (páginas vistas, ubicación general, tipo de dispositivo) y así poder mejorarlo. Estos datos son anónimos y nunca se venden. Puedes retirar tu consentimiento en cualquier momento borrando los datos del sitio en tu navegador y volviendo a visitarlo.",
      "privacyPolicy.ordersHeading": "Pedidos y Pagos",
      "privacyPolicy.ordersBody": "Cuando realizas una compra, tu pago se procesa de forma segura a través de Stripe. No almacenamos los datos de tu tarjeta nosotros mismos. Las propias prácticas de privacidad de Stripe rigen cómo se maneja tu información de pago.",
      "privacyPolicy.rightsHeading": "Tus Derechos",
      "privacyPolicy.rightsBody": "Según tu ubicación, es posible que tengas derecho a acceder, corregir, eliminar o exportar los datos personales que tenemos sobre ti, y a retirar el consentimiento para las cookies analíticas en cualquier momento. [Añade aquí los datos de tu responsable del tratamiento y cualquier derecho regional adicional.]",
      "privacyPolicy.manageHeading": "Gestionar tus Preferencias de Cookies",
      "privacyPolicy.manageBody": "Puedes aceptar o rechazar las cookies no esenciales en cualquier momento mediante el aviso de cookies que aparece en tu primera visita, o borrando los datos del sitio en tu navegador para volver a verlo.",
      "privacyPolicy.contactHeading": "Contacto",
      "privacyPolicy.contactBody": "Para preguntas sobre esta política, contáctanos a través de nuestra",
      "privacyPolicy.contactBodyEnd": "página.",
