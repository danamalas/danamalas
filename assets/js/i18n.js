...
var ABO_I18N = (function () {
  ...
  var T = {
    en: {
      ...
      "cookieConsent.text": "Your privacy matters. We use cookies to run our site and analyze traffic. By clicking \"Accept All\", you agree to our <a href=\"cookie-policy.html\">Cookie Policy</a>.",
      ...
      "title.cookiePolicy": "Cookie Policy — ABÔ Atelier",
      "cookiePolicy.title": "Cookie Policy",
      "cookiePolicy.placeholder": "Placeholder policy — replace this page with ABÔ Atelier's actual, lawyer-reviewed cookie policy before relying on it.",
      "cookiePolicy.whatAreHeading": "What Are Cookies?",
      "cookiePolicy.whatAreBody": "Cookies are small pieces of data stored on your device that help websites function and understand how they're used.",
      "cookiePolicy.necessaryHeading": "Necessary Cookies",
      "cookiePolicy.necessaryBody": "These are required for the site to work correctly — for example, remembering the contents of your cart and your selected language. They cannot be disabled and do not track you across other sites.",
      "cookiePolicy.analyticsHeading": "Analytics Cookies",
      "cookiePolicy.analyticsBody": "With your consent, we use Google Analytics to understand how visitors use our site (pages viewed, general location, device type) so we can improve it. This data is anonymized and never sold. You can withdraw consent at any time by clearing your browser's site data and revisiting the site.",
      "cookiePolicy.manageHeading": "Managing Your Preferences",
      "cookiePolicy.manageBody": "You can accept or reject non-essential cookies at any time via the cookie banner shown on your first visit, or by clearing your browser's site data to see it again.",
      "cookiePolicy.contactHeading": "Contact",
      "cookiePolicy.contactBody": "For questions regarding this policy, reach out via our",
      "cookiePolicy.contactBodyEnd": "page.",
    ...
    es: {
      ...
      "cart.subtotal": "Subtotal",
      "cart.checkout": "Pagar",
      "cart.checkingOut": "Redirigiendo…",
      "cart.checkoutError": "Algo salió mal. Inténtalo de nuevo.",
      "cart.closeAria": "Cerrar carrito",
      "cart.removeAria": "Eliminar artículo",
      ...
      "story.p3": "Este es el lugar donde tu historia puede formar parte de la nuestra. Únete a nuestra comunidad <a href=\"the-scar-project.html\">aquí</a>.",
      ...
      "contact.country": "Grecia",
      "contact.returnsLabel": "Para cualquier consulta, escríbenos a",
      ...
      "wizard.step02": "02 — Hoy",
      "wizard.step03": "03 — Sobre Ti",
      ...
      "wizard.optionVideoByUs": "Me gustaría que crearan un vídeo anónimo para mí",
      "wizard.optionOwnVideo": "Me gustaría crear mi propio vídeo",
      ...
      "wizard.submitError": "Algo salió mal al enviar tu historia. Inténtalo de nuevo.",
      ...
      "cookieConsent.text": "Tu privacidad importa. Utilizamos cookies para operar nuestro sitio y analizar el tráfico. Al hacer clic en \"Aceptar Todo\", aceptas nuestra <a href=\"cookie-policy.html\">Política de Cookies</a>.",
      "cookieConsent.acceptAll": "Aceptar Todo",
      "cookieConsent.rejectAll": "Rechazar Todo",
      "cookieConsent.manageSettings": "Gestionar Preferencias",
      "cookieConsent.settingsTitle": "Preferencias de Cookies",
      "cookieConsent.necessaryLabel": "Necesarias",
      "cookieConsent.necessaryDesc": "Necesarias para el funcionamiento del sitio (carrito, idioma). Siempre activas.",
      "cookieConsent.analyticsLabel": "Analíticas",
      "cookieConsent.analyticsDesc": "Nos ayudan a entender el tráfico del sitio mediante Google Analytics.",
      "cookieConsent.savePreferences": "Guardar Preferencias",

      "title.cookiePolicy": "Política de Cookies — ABÔ Atelier",
      "cookiePolicy.title": "Política de Cookies",
      "cookiePolicy.placeholder": "Política de marcador de posición — reemplace esta página con la política de cookies real de ABÔ Atelier, revisada por un abogado, antes de confiar en ella.",
      "cookiePolicy.whatAreHeading": "¿Qué son las Cookies?",
      "cookiePolicy.whatAreBody": "Las cookies son pequeños datos almacenados en tu dispositivo que ayudan a que los sitios web funcionen y a entender cómo se utilizan.",
      "cookiePolicy.necessaryHeading": "Cookies Necesarias",
      "cookiePolicy.necessaryBody": "Son necesarias para que el sitio funcione correctamente, por ejemplo, para recordar el contenido de tu carrito y el idioma seleccionado. No se pueden desactivar y no te rastrean en otros sitios.",
      "cookiePolicy.analyticsHeading": "Cookies Analíticas",
      "cookiePolicy.analyticsBody": "Con tu consentimiento, utilizamos Google Analytics para entender cómo los visitantes usan nuestro sitio (páginas vistas, ubicación general, tipo de dispositivo) y así poder mejorarlo. Estos datos son anónimos y nunca se venden. Puedes retirar tu consentimiento en cualquier momento borrando los datos del sitio en tu navegador y volviendo a visitarlo.",
      "cookiePolicy.manageHeading": "Gestionar tus Preferencias",
      "cookiePolicy.manageBody": "Puedes aceptar o rechazar las cookies no esenciales en cualquier momento mediante el aviso de cookies que aparece en tu primera visita, o borrando los datos del sitio en tu navegador para volver a verlo.",
      "cookiePolicy.contactHeading": "Contacto",
      "cookiePolicy.contactBody": "Para preguntas sobre esta política, contáctanos a través de nuestra",
      "cookiePolicy.contactBodyEnd": "página.",
    ...
    fr: {
      ...
      "cookieConsent.text": "Votre vie privée compte. Nous utilisons des cookies pour faire fonctionner notre site et analyser le trafic. En cliquant sur « Tout accepter », vous acceptez notre <a href=\"cookie-policy.html\">Politique de Cookies</a>.",
      "cookieConsent.acceptAll": "Tout Accepter",
      "cookieConsent.rejectAll": "Tout Refuser",
      ...
      "title.cookiePolicy": "Politique de Cookies — ABÔ Atelier",
      "cookiePolicy.title": "Politique de Cookies",
      "cookiePolicy.placeholder": "Politique provisoire — remplacez cette page par la véritable politique de cookies d'ABÔ Atelier, revue par un avocat, avant de vous y fier.",
      "cookiePolicy.whatAreHeading": "Que sont les Cookies ?",
      "cookiePolicy.whatAreBody": "Les cookies sont de petites données stockées sur votre appareil qui aident les sites web à fonctionner et à comprendre comment ils sont utilisés.",
      "cookiePolicy.necessaryHeading": "Cookies Nécessaires",
      "cookiePolicy.necessaryBody": "Ils sont nécessaires au bon fonctionnement du site — par exemple, pour mémoriser le contenu de votre panier et la langue sélectionnée. Ils ne peuvent pas être désactivés et ne vous suivent pas sur d'autres sites.",
      "cookiePolicy.analyticsHeading": "Cookies Analytiques",
      "cookiePolicy.analyticsBody": "Avec votre consentement, nous utilisons Google Analytics pour comprendre comment les visiteurs utilisent notre site (pages consultées, localisation générale, type d'appareil) afin de l'améliorer. Ces données sont anonymisées et jamais vendues. Vous pouvez retirer votre consentement à tout moment en effaçant les données du site dans votre navigateur puis en revisitant le site.",
      "cookiePolicy.manageHeading": "Gérer vos Préférences",
      "cookiePolicy.manageBody": "Vous pouvez accepter ou refuser les cookies non essentiels à tout moment via la bannière de cookies affichée lors de votre première visite, ou en effaçant les données du site dans votre navigateur pour la revoir.",
      "cookiePolicy.contactHeading": "Contact",
      "cookiePolicy.contactBody": "Pour toute question concernant cette politique, contactez-nous via notre",
      "cookiePolicy.contactBodyEnd": "page.",
    ...
    ar: {
      ...
      "wizard.optionVideoByUs": "أرغب في أن يتم إنشاء فيديو مجهول الهوية لي",
      ...
      "cookieConsent.text": "خصوصيتك مهمة. نستخدم ملفات تعريف الارتباط لتشغيل موقعنا وتحليل حركة المرور. بالنقر على \"قبول الكل\"، فإنك توافق على <a href=\"cookie-policy.html\">سياسة ملفات تعريف الارتباط</a> الخاصة بنا.",
      "cookieConsent.acceptAll": "قبول الكل",
      "cookieConsent.rejectAll": "رفض الكل",
      ...
      "title.cookiePolicy": "سياسة ملفات تعريف الارتباط — ABÔ Atelier",
      "cookiePolicy.title": "سياسة ملفات تعريف الارتباط",
      "cookiePolicy.placeholder": "سياسة نموذجية — استبدل هذه الصفحة بسياسة ملفات تعريف الارتباط الفعلية لـ ABÔ Atelier، بعد مراجعتها من قبل محامٍ، قبل الاعتماد عليها.",
      "cookiePolicy.whatAreHeading": "ما هي ملفات تعريف الارتباط؟",
      "cookiePolicy.whatAreBody": "ملفات تعريف الارتباط هي بيانات صغيرة تُخزَّن على جهازك تساعد المواقع على العمل وفهم كيفية استخدامها.",
      "cookiePolicy.necessaryHeading": "ملفات تعريف الارتباط الضرورية",
      "cookiePolicy.necessaryBody": "هذه ضرورية لعمل الموقع بشكل صحيح — على سبيل المثال، لتذكر محتويات سلتك واللغة التي اخترتها. لا يمكن تعطيلها ولا تتعقبك عبر مواقع أخرى.",
      "cookiePolicy.analyticsHeading": "ملفات تعريف ارتباط التحليلات",
      "cookiePolicy.analyticsBody": "بموافقتك، نستخدم Google Analytics لفهم كيفية استخدام الزوار لموقعنا (الصفحات المُشاهَدة، الموقع العام، نوع الجهاز) لنتمكن من تحسينه. هذه البيانات مجهولة الهوية ولا تُباع أبدًا. يمكنك سحب موافقتك في أي وقت عن طريق مسح بيانات الموقع من متصفحك وزيارة الموقع مرة أخرى.",
      "cookiePolicy.manageHeading": "إدارة تفضيلاتك",
      "cookiePolicy.manageBody": "يمكنك قبول أو رفض ملفات تعريف الارتباط غير الضرورية في أي وقت عبر شعار ملفات تعريف الارتباط الذي يظهر عند زيارتك الأولى، أو عن طريق مسح بيانات الموقع من متصفحك لرؤيته مرة أخرى.",
      "cookiePolicy.contactHeading": "اتصل بنا",
      "cookiePolicy.contactBody": "لأية أسئلة بخصوص هذه السياسة، تواصل معنا عبر صفحة",
      "cookiePolicy.contactBodyEnd": "الخاصة بنا.",
